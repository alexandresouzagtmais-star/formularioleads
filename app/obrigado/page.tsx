  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-md">
        ...
        <Link
          href="https://gtmais.com.br"
          className="inline-block px-8 py-4 rounded-full font-black text-base transition-all duration-200"
          style={{ background: GT_GREEN, color: GT_DARK }}
        >
          Conheça a GT+ →
        </Link>
      </div>
